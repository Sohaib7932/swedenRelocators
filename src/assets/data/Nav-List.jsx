...
export const housingChildLinks = [
  ...
  // },
  {
    ...
    Link: 'https://swedenrelocators.se/pages/housing/availableHousing',
  },
  {
    id: 3,
    ...
    Link: 'https://swedenrelocators.se/pages/housing/rentOutHousing',
  },
  {
    id: 4,
    ...
    Link: 'https://swedenrelocators.se/pages/housing/lookingForHousing',
  },
];
export const assessmentChidldLinks = [
  {
    ...
    icons: <MdBusinessCenter color="#fff" className="tw-text-[28px] tw-text-white tw-mb-0" />,
    Link: 'https://swedenrelocators.se/pages/assessment/business_visa_assessment',
  },
  {
    id: 2,
    title: 'Family Reunification',
    ...
    icons: <MdFamilyRestroom color="#fff" className="tw-text-[28px] tw-text-white tw-mb-0" />,
    Link: 'https://swedenrelocators.se/pages/assessment/family_reunification_assessment',
  },
  {
    id: 3,
    ...
    icons: <GiEuropeanFlag color="#fff" className="tw-text-[28px] tw-text-white tw-mb-0" />,
    Link: 'https://swedenrelocators.se/pages/assessment/long_term_eu_status_assessment',
  },
  {
    id: 4,
    title: 'Student Visa',
    ...
    icons: <PiStudent color="#fff" className="tw-text-[28px] tw-text-white tw-mb-0" />,
    Link: 'https://swedenrelocators.se/pages/assessment/student_assessments',
  },
  {
    id: 5,
    title: 'Visit Visa',
    ...
    Link: 'https://swedenrelocators.se/pages/assessment/visit_visa_assesment',
  },
  {
    id: 6,
    title: 'Work Permit',
    ...
    icons: <CgWorkAlt color="#fff" className="tw-text-[28px] tw-text-white tw-mb-0" />,
    Link: 'https://swedenrelocators.se/pages/assessment/work_permit_assessment',
  },
  {
    id: 7,
    ...
    Link: 'https://swedenrelocators.se/pages/assessment',
  },
];
...
export const NavItems = [
  ...
  },
  {
    id: 3,
    name: 'Housing',
    url: 'https://swedenrelocators.se/pages/housing',
